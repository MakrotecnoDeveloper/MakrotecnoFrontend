...
const ReactDataTable = ({ data, columns, pagination, actions, className, selectableRows, expandableRows,tipo }) => {
  const [tableData, setTableData] = useState(data);
  const [searchText, setSearchText] = useState("");
  const [rowsPerPageS, setRowsPerPage] = useState(10);
  const [mobileView, setMobileView] = useState();

  var search='Search By To';
  if (tipo=='tranfer') {
    {/*console.log("tipo llegada entro tranfer",tipo);*/}
    search='Search By CreatedBy'
  }else if(tipo=='recharg'){
    {/*console.log("tipo llegada entro recharg",tipo);*/}
    search='Search By CreatedBy'
  }else if(tipo=='sales'){
    {/*console.log("tipo llegada entro recharg",tipo);*/}
    search='Search By Buyer Number'
  }else{
    {/*console.log("tipo llegada entro deposit",tipo);*/}
      ...
      defaultData = data.filter((item) => {
        if (tipo=='tranfer') {
          ...
          if (item.CreatedBy == null) {
            ...
            return item.CreatedBy.toLowerCase().includes(searchText.toLowerCase());  
          }          
        }else if(tipo=='recharg'){
          {/*console.log("tipo llegada entro recharg",tipo);*/}
          if (item.CreatedBy == null) {
          ...
          {/*console.log("tipo llegada entro recharg",tipo);*/}
          if (item.BuyerNumber == null) {
            return item.BuyerNumber;
          }else{
            return item.BuyerNumber.toLowerCase().includes(searchText.toLowerCase());
          }
        }else{
          {/*console.log("tipo llegada entro deposit",tipo);*/}
          if (item.ToUsername == null) {
            return item.ToUsername;
          }else{
            return item.ToUsername.toLowerCase().includes(searchText.toLowerCase());
          }
